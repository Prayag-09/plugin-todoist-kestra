...
@NoArgsConstructor
@Schema(
    title = "Reopen a completed task in Todoist",
    description = "Reopens a previously completed task in Todoist"
)
@Plugin(
    examples = {
        @Example(
...
public class ReopenTask extends AbstractTodoistTask implements RunnableTask<VoidOutput> {
    ...
    public VoidOutput run(RunContext runContext) throws Exception {
        ...
        client.postVoid("/tasks/" + rTaskId + "/reopen");
        
        logger.info("Task {} reopened successfully", rTaskId);
